class User < ApplicationRecord
    has_many :expert_projects, -> { order "id ASC" }, class_name: 'Project', foreign_key: :expert_id
    has_many :novice_projects, -> { order "id ASC" }, class_name: 'Project', foreign_key: :novice_id
    has_many :messages
